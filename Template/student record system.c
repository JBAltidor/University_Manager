...
void window(){
    ...
    gotoxy(20,3);
    printf("Univesite Quisqueya, Port-au-Prince, Haiti");
    gotoxy(31,4);
    printf("Estd.: 1988");
    gotoxy(25,24);
    SetColor(17);
...
void main_window(){
    ...
    int x = 2;
    while(1){
        gotoxy(x,8);printf("1. Menu 01 : Gestion des accès");
        gotoxy(x,10);printf("2. Menu 02 : Cours");
        gotoxy(x,12);printf("3. Menu 03 : Administration et comptabilité");
        gotoxy(x,14);printf("4. Menu 04 : Bibliothèque");
        gotoxy(x,16);printf("5. Menu 05 : Quitter le programme");
        gotoxy(x,18);printf("Faites votre choix : [ 1, 2, 3, 4, 5 ] :");
